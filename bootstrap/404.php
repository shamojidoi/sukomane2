...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="color: black;">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="404.php"  data-target="#collapseTwo"
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        ...
                        <a href="index.php">&larr; My page</a>
                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Motion Analysis for Baseball 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
